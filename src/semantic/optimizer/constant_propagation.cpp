...
void ConstantPropagationPass::run(Program& ast) {
    ...
    // Second pass: standard constant propagation (eliminates if statements with constant conditions)
    processBlock(ast.statements);
    
    // Third pass: Dead Store Elimination - remove redundant assignments
